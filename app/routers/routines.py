...
def _serialize_day(day: RoutineDay) -> dict:
        ...
        for blk in sorted(day.blocks, key=lambda b: b.order_index):
            ...
            for ex in blk.exercises:
                exercises.append({
                    ...
                    "image": ex.training.image if ex.training else None,
                    "video_url": ex.training.video_url if ex.training else None,
                    "series": ex.series,
    ...
    if old_details:
        exercises = [{
            ...
            "image": d.training.image if d.training else None,
            "video_url": d.training.video_url if d.training else None,
            "series": d.series,
